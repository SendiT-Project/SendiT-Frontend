...
const Users = ({setLoading}) => {
  ...
  return (
    <div> 
      <Menu />
      <div className='page-contents ml-48 p-10'>
      <div className="header border mb-5 flex justify-between">
          <div className="search-bar mt-2 items-center ml-10">
            <input
              type="text"
        ...
        <div>
          ...
          <table className="min-w-full border border-gray-300 mx-4 shadow-md">
